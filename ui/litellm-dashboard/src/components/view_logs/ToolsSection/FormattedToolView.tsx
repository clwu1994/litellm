  ...
  return (
    <div>
      ...
      {parameterRows.length > 0 && (
        <div>
          <span className="mb-2 block text-xs text-muted-foreground">{t("tools.parameters")}</span>
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead>{t("tools.parameter")}</TableHead>
      ...
      {tool.called && tool.callData && (
        <div className="mt-4">
          <span className="mb-2 block text-xs text-muted-foreground">{t("tools.calledWith")}</span>

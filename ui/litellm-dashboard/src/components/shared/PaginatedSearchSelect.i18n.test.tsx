...
const renderSelect = (overrides: Partial<React.ComponentProps<typeof PaginatedSearchSelect>> = {}) =>
  renderWithProviders(
    <PaginatedSearchSelect options={[]} onValueChange={vi.fn()} onSearchChange={vi.fn()} {...overrides} />,
  );

describe("PaginatedSearchSelect Chinese copy", () => {
  beforeEach(async () => {

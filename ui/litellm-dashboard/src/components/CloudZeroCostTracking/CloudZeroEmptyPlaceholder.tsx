  ...
  return (
    <div className="mx-auto mt-8 max-w-2xl rounded-lg border border-dashed border-border bg-card p-12 text-center">
      <div className="flex flex-col items-center gap-2">
        ...
        <h4 className="text-base font-semibold">{t("cloudzero.emptyTitle")}</h4>
        <p className="mx-auto max-w-md text-sm text-muted-foreground">{t("cloudzero.emptyDescription")}</p>

...
const AgentsPanel: React.FC<AgentsPanelProps> = ({ accessToken, userRole, teams }) => {
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      toast.success(t("list.toast.deleted", { name: agentToDelete.name }));
    ...
    <div className="w-full mx-auto flex-auto overflow-y-auto m-8 p-2">
      <div className="flex flex-col gap-2 mb-4">
        ...
        <Alert className="mb-3">
          <Info />
          <AlertTitle>{t("list.alert.title")}</AlertTitle>
          <AlertDescription>{t("list.alert.description")}</AlertDescription>
        </Alert>
        {isAdmin && (
        ...
        >
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                {t("list.deleteDialog.description", { name: agentToDelete.name })}
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>

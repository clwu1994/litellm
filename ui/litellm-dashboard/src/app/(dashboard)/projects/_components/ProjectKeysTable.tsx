...
function EmptyState() {
  ...
  return (
    <div className="flex flex-col items-center gap-1 py-6">
      ...
      <div className="text-sm font-medium text-foreground">{t("keys.emptyTitle")}</div>
      <div className="text-sm text-muted-foreground">{t("keys.emptyDescription")}</div>
    </div>
  );
}

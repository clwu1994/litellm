          ...
          >
            ...
            {isLoading && onCancel ? (
              <InputGroupButton
                type="button"
                size="icon-sm"
                aria-label={t("chat.input.stopRequest")}
...
export function CodeInterpreterToggle({ enabled, onToggle }: CodeInterpreterToggleProps) {
  ...
  return (
    <Tooltip>
      <TooltipTrigger
        render={
          <Button
            ...
            aria-label={enabled ? t("chat.codeInterpreter.disableAria") : t("chat.codeInterpreter.enableAria")}
            onClick={onToggle}
          />
        }
      >
      ...
      <TooltipContent>
        {enabled ? t("chat.codeInterpreter.disableAria") : t("chat.codeInterpreter.enableAria")}
      </TooltipContent>
    </Tooltip>
  );
}

...
export function GuardrailTestResults({ results, errors }: GuardrailTestResultsProps) {
  ...
  return (
    <div className="space-y-3 border-t border-border pt-4">
      <h3 className="text-sm font-semibold">{t("testResults.title")}</h3>
                    ...
                    {!isCollapsed && (
                      <Button
                        ...
                        onClick={async () => {
                          ...
                          if (success) {
                            toast.success(t("testResults.toast.resultCopied"));
                          } else {
                            toast.fromError(t("testResults.toast.copyFailed"));
                          }
                        }}
                      >
                        <Copy />
                ...
                {!isCollapsed && (
                  <>
                    ...
                    <div className="text-xs text-muted-foreground">
                      <span className="font-medium">{t("testResults.charactersLabel")}</span>{" "}
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <div className="flex-1">
                    <div className="mb-1 flex items-center justify-between">
                      ...
                      >
                        {t("testResults.errorLabel", { name: errorItem.guardrailName })}
                      </p>
                      <div className="flex items-center space-x-1 text-xs text-muted-foreground">
                        <Clock className="size-3" />

...
const ClaudeCodePluginsPanel: React.FC<ClaudeCodePluginsPanelProps> = ({ accessToken, userRole }) => {
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      toast.success(t("delete.success", { name: pluginToDelete.displayName }));
      fetchPlugins();
    } catch (error) {
          ...
          <div className="flex flex-col gap-2 mb-4">
            ...
            <p className="text-sm text-muted-foreground">
              <Trans
                ...
                components={{ code: <code className="bg-muted px-1 rounded-sm" /> }}
              />
            </p>
        ...
        >
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <p className="text-sm text-muted-foreground">{t("delete.cannotUndo")}</p>
            </AlertDialogHeader>
            <AlertDialogFooter>

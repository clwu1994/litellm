  ...
  return (
    <div className="p-8">
        ...
        <InputGroup className="max-w-[400px]">
          ...
          {searchText && (
            <InputGroupAddon align="inline-end">
              <InputGroupButton size="icon-xs" aria-label={t("page.clearSearchAria")} onClick={() => setSearchText("")}>
                <X />
              </InputGroupButton>
            </InputGroupAddon>
          )}
      ...
      <DeleteResourceModal
        ...
        resourceInformation={[
          { label: t("deleteModal.labels.id"), value: groupToDelete?.id, code: true },
          { label: t("deleteModal.labels.name"), value: groupToDelete?.name },
          { label: t("deleteModal.labels.description"), value: groupToDelete?.description || "—" },
        ]}

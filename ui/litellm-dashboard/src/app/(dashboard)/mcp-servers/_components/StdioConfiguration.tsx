    ...
    <MountedFormField
      label={
        <span className="text-sm font-medium text-foreground flex items-center">
          {t("form.stdio.configLabel")}
          <SimpleTooltip content={t("form.stdio.configTooltip")}>
      ...
      rules={{
        validate: {
          ...(required ? { required: requiredRule(t("form.stdio.configRequired")) } : {}),
          json: parsesAsJson(t("form.stdio.configInvalidJson")),
        },
      }}
    >
      {(control) => (

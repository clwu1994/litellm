        ...
        <FieldGroup>
          <Field>
            <FieldLabel htmlFor={PROVIDER_FIELD_ID}>
              {labelWithHint(t("common.provider"), t("forms.providerHint"))}
            </FieldLabel>
            <Combobox
              items={options}
            ...
            >
              <ComboboxInput id={PROVIDER_FIELD_ID} placeholder={t("forms.providerPlaceholder")} className="w-full">
                {selectedOption && (
              ...
              <ComboboxContent>
                <ComboboxEmpty>{t("forms.noProviders")}</ComboboxEmpty>
                <ComboboxList>
          ...
          <Field>
            <FieldLabel htmlFor={DISCOUNT_FIELD_ID}>
              {labelWithHint(t("common.discountPercentage"), t("forms.discountPercentageHint"))}
            </FieldLabel>

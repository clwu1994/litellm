  ...
  return (
    <div className="mx-4 mt-4 flex flex-col gap-4">
      ...
      {selectedOrgId ? (
        ...
        <>
          <p className="text-sm text-muted-foreground">{t("hint.clickToView")}</p>
          <OrganizationFilters
            filters={filters}
      ...
      <DeleteResourceModal
        ...
        resourceInformation={[{ label: t("delete.organizationId"), value: orgToDelete, code: true }]}

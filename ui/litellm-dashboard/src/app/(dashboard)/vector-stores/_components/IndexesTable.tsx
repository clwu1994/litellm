...
function EmptyState() {
  ...
  return (
    <div className="flex flex-col items-center gap-1 py-6">
      ...
      <div className="text-sm font-medium text-foreground">{t("indexes.emptyTitle")}</div>
      <div className="text-sm text-muted-foreground">{t("indexes.emptyDescription")}</div>
    </div>
  );
}
...
const IndexesTable: React.FC<IndexesTableProps> = ({
  ...
  return (
    <DataTable
      ...
      isLoading={isLoading}
      loadingMessage={t("indexes.loading")}
